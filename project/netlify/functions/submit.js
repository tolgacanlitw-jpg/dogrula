...
const FILE_LABELS = {
  // kyc
  selfie:             'Selfie + Domain Notu',
  exchangeScreenshot: 'Borsa Gönderim Cüzdanı',
  // email
  idFrontEmail:       'Kimlik Ön Yüz',
  idBackEmail:        'Kimlik Arka Yüz',
  selfieEmail:        'Selfie + Domain Notu',
  // phone
  idFrontPhone:       'Kimlik Ön Yüz',
  idBackPhone:        'Kimlik Arka Yüz',
  selfiePhone:        'Selfie + Domain Notu',
  // belge
  idFront:            'Kimlik Ön Yüz',
  idBack:             'Kimlik Arka Yüz',
  selfieBelge:        'Selfie + Domain Notu',
};
